...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post memes_url, params: { meme: { link: @meme.link, user_id: @meme.user_id, votes: @meme.votes } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { link: @meme.link, user_id: @meme.user_id, votes: @meme.votes } }
